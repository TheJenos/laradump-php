...
class SqlFormatter
{
    ...
    public static $quote_attributes = 'class="text-blue-500"';
    public static $backtick_quote_attributes = 'class="text-purple-500 dark:text-gray-200"';
    public static $reserved_attributes = 'class="font-bold uppercase"';
    public static $boundary_attributes = '';
    public static $number_attributes = 'class="text-green-500"';
    public static $word_attributes = 'class="text-gray-900"';
    public static $error_attributes = 'class="bg-red-500"';
    public static $comment_attributes = 'class="text-gray-500"';
    public static $variable_attributes = 'class="text-orange-500"';
    public static $pre_attributes = 'class="text-black dark:text-white"';
